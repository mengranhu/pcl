...
#define CLIP_HEIGHT 1 //截取掉高于雷达自身0.2米的点
...
private:
    ...
    struct PointXYZIRTColor {
        ...
        size_t radial_div;     // index of the radial divsion to which this point
                               // belongs to
        size_t concentric_div; // index of the concentric division to which
                               // this points belongs to
    ...
    void
    classify_pc(std::vector<PointCloudXYZIRTColor> &in_radial_ordered_clouds,
